...
export default function PixelCard({
    ...
    <div className="w-screen relative mt-11 z-10 ">
      ...
      >
        ...
        <div className="flex flex-col gap-3 p-6">
          <h1 className="text-2xl sm:text-5xl text-center font-batman">About Us</h1>
          <p className="max-sm:hidden text-base sm:text-lg text-justify leading-6 font-orbitron text-white ">
 ...
 <p className="sm:hidden  text-base sm:text-lg text-justify leading-6 font-orbitron text-white  ">
